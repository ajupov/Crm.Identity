...
using Crm.Identity.Areas.OAuth.Attributes.Security;
...
using Crm.Identity.Areas.OAuth.Models.VerifyEmail;
using Crm.Identity.Areas.OAuth.Models.VerifyPhone;
using Crm.Identity.Areas.OAuth.Services;
using Crm.Identity.Areas.OAuth.Validators;
using Crm.Identity.Areas.OAuth.ViewModels.Authorize;
using Crm.Identity.Areas.OAuth.ViewModels.ChangeEmail;
using Crm.Identity.Areas.OAuth.ViewModels.ChangePassword;
using Crm.Identity.Areas.OAuth.ViewModels.ChangePhone;
using Crm.Identity.Areas.OAuth.ViewModels.Register;
using Crm.Identity.Areas.OAuth.ViewModels.ResetPassword;
using Crm.Identity.Areas.OAuth.ViewModels.VerifyPhone;
