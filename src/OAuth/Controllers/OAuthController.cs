...
using Ajupov.Identity.src.OAuth.Attributes.Security;
...
using Ajupov.Identity.src.OAuth.Models.VerifyEmail;
using Ajupov.Identity.src.OAuth.Models.VerifyPhone;
using Ajupov.Identity.src.OAuth.Services;
using Ajupov.Identity.src.OAuth.Validators;
using Ajupov.Identity.src.OAuth.ViewModels.Authorize;
using Ajupov.Identity.src.OAuth.ViewModels.ChangeEmail;
using Ajupov.Identity.src.OAuth.ViewModels.ChangePassword;
using Ajupov.Identity.src.OAuth.ViewModels.ChangePhone;
using Ajupov.Identity.src.OAuth.ViewModels.Register;
using Ajupov.Identity.src.OAuth.ViewModels.ResetPassword;
using Ajupov.Identity.src.OAuth.ViewModels.VerifyPhone;
...
namespace Ajupov.Identity.src.OAuth.Controllers
{
    [SecurityHeaders]
    [Route("OAuth")]
    public class OAuthController : DefaultMvcController
    {
        ...
        public async Task<ActionResult> Authorize(GetAuthorizeRequest request, CancellationToken ct)
        {
            ...
            return View("~/src/OAuth/Views/Authorize/Authorize.cshtml", model);
        }
        ...
        public async Task<ActionResult> Register(GetRegisterRequest request, CancellationToken ct)
        {
            ...
            return View("~/src/OAuth/Views/Register/Register.cshtml", model);
        }
        ...
        public ActionResult ChangeEmail(GetChangeEmailRequest request)
        {
            ...
            return View("~/src/OAuth/Views/ChangeEmail/ChangeEmail.cshtml", model);
        }
        ...
        public async Task<ActionResult> ChangeEmail([FromForm] PostChangeEmailRequest request, CancellationToken ct)
        {
            ...
            return View("~/src/OAuth/Views/ChangeEmail/ChangeEmailConfirmation.cshtml");
        }
        ...
        public async Task<ActionResult> VerifyEmail(VerifyEmailRequest request, CancellationToken ct)
        {
            ...
            return View("~/src/OAuth/Views/VerifyEmail/EmailVerified.cshtml");
        }
        ...
        public ActionResult ChangePhone(GetChangePhoneRequest request)
        {
            ...
            return View("~/src/OAuth/Views/ChangePhone/ChangePhone.cshtml", model);
        }
        ...
        public ActionResult VerifyPhone(GetVerifyPhoneRequest request)
        {
            ...
            return View("~/src/OAuth/Views/VerifyPhone/VerifyPhone.cshtml", model);
        }
        ...
        public async Task<ActionResult> VerifyPhone([FromForm] PostVerifyPhoneRequest request, CancellationToken ct)
        {
            ...
            {
                return View("~/src/OAuth/Views/VerifyPhone/PhoneVerified.cshtml");
            }
        ...
        public ActionResult ChangePassword(GetChangePasswordRequest request)
        {
            ...
            return View("~/src/OAuth/Views/ChangePassword/ChangePassword.cshtml", model);
        }
            ...
            CancellationToken ct)
        {
            ...
            return View("~/src/OAuth/Views/ChangePassword/PasswordChanged.cshtml");
        }
        ...
        public ActionResult ResetPassword(GetResetPasswordRequest request)
        {
            ...
            return View("~/src/OAuth/Views/ResetPassword/ResetPassword.cshtml", model);
        }
            ...
            CancellationToken ct)
        {
            ...
            return View("~/src/OAuth/Views/ResetPassword/ResetPasswordConfirmation.cshtml");
        }
            ...
            CancellationToken ct)
        {
            ...
            return View("~/src/OAuth/Views/ResetPassword/SetNewPassword.cshtml", model);
        }
            ...
            CancellationToken ct)
        {
            ...
            return View("~/src/OAuth/Views/ResetPassword/NewPasswordSet.cshtml");
        }
    }
}